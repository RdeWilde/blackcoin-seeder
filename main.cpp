...
static const string mainnet_seeds[] = {"dnsseed.ionomy.com", "45.32.211.127", "dnsseed.ionomy.nl", ""};
static const string testnet_seeds[] = {"dnsseedtest.ionomy.nl", "95.85.26.115"};
...
//    db.Add(CService("1111:2222:3:4444::5", 15714, false), true);
    ...
    db.Add(CService("67.187.186.84", 37398, false), true);
    db.Add(CService("139.162.220.51", 38648, false), true);
    db.Add(CService("198.50.205.96", 58851, false), true);
    db.Add(CService("95.85.26.115", 51002, false), true);
  }
  do {
